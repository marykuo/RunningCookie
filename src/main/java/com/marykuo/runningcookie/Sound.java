...
public class Sound {
    public static synchronized void play(int fileName) 
    {
    	...
    	address[BACK_GROUNG]="./image/audio/background.wav";
    	address[JUMP]="./image/audio/jump.wav";
    	address[JUMP2]="./image/audio/jump2.wav";
    	address[FALLING]="./image/audio/falling.wav";
    	address[EATCAKE]="./image/audio/eatcake.wav";
    	address[UP_HEARTVALUE]="./image/audio/up_heartvalue.wav";
    	address[HIT]="./image/audio/hit.wav";
